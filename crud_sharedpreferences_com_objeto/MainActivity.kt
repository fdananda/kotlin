...
class MainActivity : AppCompatActivity() {
    ...
    private var crudPreferencias: CrudPreferencias? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        crudPreferencias = CrudPreferencias(context)
    ...
    fun listar(view: View?) {
        ...
        val atributo1: String? = crudPreferencias!!.read()!!.getAtributo1()
        val atributo2: String? = crudPreferencias!!.read()!!.getAtributo2()
        val atributo3: String? = crudPreferencias!!.read()!!.getAtributo3()
